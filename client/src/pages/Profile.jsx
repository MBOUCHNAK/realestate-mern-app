                  ...
                  <p className="text-sm self-center">
                    {fileUploadError ? (
                      <span className="text-red-700">
                        Error Image upload (image must be less the 2 mb)
                      </span>
                    ) : filePerc > 0 && filePerc < 100 ? (
                      <span className="text-state-700">{`Uploading ${filePerc}%`}</span>
                    ) : filePerc === 100 ? (
...
>
  Create Listing
                ...
                <p className='text-green-700 mt-5'>{updateSuccess ? 'Profile successfully updated' : ''}</p>
                ...
                {userListings && userListings.length > 0 &&
                    <div className='flex flex-col gap-4'>
                      ...
                      {userListings.map((listing) => (
                          <div key={listing._id}  className='rounded-lg border p-3 flex justify-between items-center gap-4'>
